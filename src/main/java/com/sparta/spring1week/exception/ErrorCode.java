...
public enum ErrorCode {
    ...
    TOKEN_ERROR(400, "T001", "토큰이 유효하지 않습니다."),

    TOKEN_NULL_ERROR(400, "T002", "토큰이 존재하지 않습니다."),

    USER_ERROR(400, "U001", "회원을 찾을 수 없습니다."),

    USER_PASSWORD_ERROR(400, "U002", "패스워드가 잘못됫습니다."),

    USER_DUF_ERROR(400, "U003", "중복된 username입니다."),

    MODIFY_ERROR(400, "U004", "작성자만 삭제/수정할 수 있습니다."),

    BLOG_ERROR(400, "B001", "게시글이 없습니다."),

    COMMENT_ERROR(400, "B002", "댓글이 없습니다."),

    ADMIN_ERROR(400, "A001", "관리자가 아닙니다."),
